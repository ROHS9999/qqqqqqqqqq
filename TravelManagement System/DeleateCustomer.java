...
public class DeleateCustomer extends JFrame implements ActionListener {
    JButton DeleteButton;

    String username;
    DeleateCustomer(String username) {
        ...
        DeleteButton.setBounds(300, 300, 100, 25);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == DeleteButton) {
            ...
            try {
                ...
                String sql4="DELETE  FROM customer WHERE username='"+username+"'";

                stmt.executeUpdate(sql);
                stmt.executeUpdate(sql2);
                stmt.executeUpdate(sql3);
                stmt.executeUpdate(sql4);
                JOptionPane.showMessageDialog(null,"Customer Delete Succesfully....");
            } catch (Exception ob) {
                ob.printStackTrace();
            }
        }
