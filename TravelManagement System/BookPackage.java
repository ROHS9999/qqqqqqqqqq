...
{
    JTextField totalPersonTExtField;
    ...
    BookPackage(String username)
    {
        ...
        JLabel selectPackagLabel=new JLabel("Select Package");
        ...
        selectChoice.add("Gold Package");
        selectChoice.add("Silver Package");
        selectChoice.add("Bronze Package");
        add(selectChoice);
        ...
        phoneField.setBounds(200,280,150,20);
        add(phoneField);
        ...
        PriceField.setBounds(200,320,150,20);
        add(PriceField);
        ...
        image.setBounds(420,80,450,300);
        add(image);
     ...
     public void actionPerformed(ActionEvent e)
     {
        ...
        else if(e.getSource()==bookPackageButton)
        {
            ...
            try {
                Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);
                Statement stmt = conn.createStatement();
                String sql ="insert into bookPackage values('"+usename+"','"+choocepackage+"','"+Person+"','"+id+"','"+number+"','"+phone+"','"+price+"')";
                stmt.executeUpdate(sql);
               JOptionPane.showMessageDialog(null,"book package succefully...");
               setVisible(false);
            } catch (Exception ob) {
                ob.printStackTrace();
            }
